...
const PRECACHE_ASSETS = [
  ...
  '/nfc/editor-qr-runtime.js?v=1.1',
  '/nfc/editor-capture-runtime.js?v=1.3',
  '/nfc/editor-user-status.js?v=1.2',
  '/nfc/editor-workspace.js?v=1.1',
  ...
  '/nfc/editor-productivity-tools.css',
  '/nfc/editor-productivity-tools.js',
  '/nfc/brand-kit.css',
  '/nfc/brand-kit-client.js',
  '/nfc/dashboard-brand-kit.js',
  '/nfc/editor-brand-kit.js',
  '/nfc/workspace.css',
  '/nfc/workspace-client.js',
  '/nfc/dashboard-workspaces.js',
  '/nfc/editor-review-workflow.js',
  '/nfc/manifest.json',
  '/nfc/logo.svg',
