...
describe('editor toolbar production release patch', () => {
  ...
  test('ships editor managers, Brand Kit and team review through a fresh cache', () => {
    ...
    expect(sw).toContain("const CACHE_VERSION = 'v27'");
    ...
    expect(sw).toContain("'/nfc/editor-qr-runtime.js?v=1.1'");
    expect(sw).toContain("'/nfc/editor-capture-runtime.js?v=1.3'");
    expect(sw).toContain("'/nfc/editor-user-status.js?v=1.2'");
    expect(sw).toContain("'/nfc/editor-workspace.js?v=1.1'");
