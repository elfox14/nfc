...
async function verifyProduction(options = {}) {
  ...
  async function checkEditorDocument(name, url) {
    checks.push(await executeCheck(name, async () => {
      ...
      assertResponse(response, body, name, [
        ...
        'editor-hydration.js', 'editor-design-loader.js', 'editor-qr-runtime.js',
        'editor-capture-runtime.js', 'editor-logo-fit.js'
      ]);
  ...
  await checkUrl('Reliable editor QR runtime', `${publicOrigin}/nfc/editor-qr-runtime.js`, [
    '/nfc/vendor/qr-code-styling.js?v=1.5.0', 'activeCardGeneration', 'autoGeneratedQrDataUrl',
    'ShareManager.saveDesign(StateManager.getStateObject())'
  ]);
  await checkUrl('Reliable editor card capture runtime', `${publicOrigin}/nfc/editor-capture-runtime.js`, [
    'allowTaint: false', 'captureBlob', 'stripExternalAssets', 'activeCaptures'
  ]);
  await checkUrl('Local styled QR renderer', `${publicOrigin}/nfc/vendor/qr-code-styling.js`, [
    'QRCodeStyling', 'getRawData'
  ]);
  await checkUrl('Local basic QR renderer', `${publicOrigin}/nfc/vendor/qrcode.min.js`, [
    'QRCode', 'CorrectLevel'
  ]);
  ...
  await checkUrl('Service Worker release cache', `${publicOrigin}/nfc/sw.js`, [
    ...
    '/nfc/editor-default-card.js', '/nfc/editor-hydration.js', '/nfc/editor-design-loader.js',
    '/nfc/editor-qr-runtime.js', '/nfc/editor-capture-runtime.js',
    '/nfc/vendor/qr-code-styling.js', '/nfc/vendor/qrcode.min.js',
