...
// 1. UPDATE homepage.original.css
const homepageCssPath = path.join(rootDir, 'homepage.original.css');
let homepageCss = fs.readFileSync(homepageCssPath, 'utf8');

// Replace the 3D card CSS with bulletproof opacity + 3D transform rules
const improvedCardCss = `
...
.card-3d-flipper.flipped .card-face-front {
    opacity: 0;
    pointer-events: none;
}

.card-3d-flipper.flipped .card-face-back {
    opacity: 1;
    pointer-events: auto;
}

.card-3d-flipper:not(.flipped) .card-face-front {
    opacity: 1;
    pointer-events: auto;
}

.card-3d-flipper:not(.flipped) .card-face-back {
    opacity: 0;
    pointer-events: none;
}
...
// Also add to homepage.original.css
homepageCss = homepageCss.replace(/\/\* 3D Interactive Card Stage \*\/[\s\S]*?\.hero-try-btn:hover \{[\s\S]*?\}/, '');
homepageCss += '\n' + improvedCardCss;
fs.writeFileSync(homepageCssPath, homepageCss, 'utf8');

// 2. Also write to homepage-interactive.css
const interactiveCssPath = path.join(rootDir, 'homepage-interactive.css');
if (fs.existsSync(interactiveCssPath)) {
    let interCss = fs.readFileSync(interactiveCssPath, 'utf8');
    interCss = interCss.replace(/\/\* 3D Interactive Card Stage \*\/[\s\S]*?\.hero-try-btn:hover \{[\s\S]*?\}/, '');
    interCss += '\n' + improvedCardCss;
    fs.writeFileSync(interactiveCssPath, interCss, 'utf8');
}

// 3. ARABIC HOMEPAGE (index.html)
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="container nav-content">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <a href="index-en.html" class="lang-btn" aria-label="Switch to English">EN</a>
            ...
            <div class="container">
                <div class="hero-story-split">
                    ...
                    <div class="hero-story-copy">
                        ...
                        <!-- Live Name Input + Design Now Button -->
                        <div class="hero-live-try-box">
                            ...
                            <a href="editor.html" class="hero-try-btn" id="hero-cta-btn" onclick="onDesignNowClick(this)">صمم الآن مجاناً</a>
                        </div>
                    ...
                    <!-- 3D Two-Sided Interactive Live Card -->
                    <div class="card-3d-interactive-stage">
                        ...
                        <div class="card-flip-action-bar">
                            <button type="button" class="card-flip-btn" id="flip-btn-action" onclick="toggleCardFlip(event)">
    ...
    <script>
        ...
        function onDesignNowClick(anchor) {
            var nameInput = document.getElementById('live-card-input');
            if (nameInput && nameInput.value && nameInput.value.trim()) {
                anchor.href = 'editor.html?name=' + encodeURIComponent(nameInput.value.trim());
            }
        }
    </script>
</body>
...
// 4. ENGLISH HOMEPAGE (index-en.html)
...
<body>
    ...
    <nav class="navbar" id="navbar">
        <div class="container nav-content">
            ...
            <div style="display: flex; align-items: center; gap: 0.75rem;">
                <a href="index.html" class="lang-btn" aria-label="التبديل إلى العربية">عربي</a>
            ...
            <div class="container">
                <div class="hero-story-split">
                    ...
                    <div class="hero-story-copy">
                        ...
                        <!-- Live Name Input + Design Free Button -->
                        <div class="hero-live-try-box">
                            ...
                            <a href="editor-en.html" class="hero-try-btn" id="hero-cta-btn" onclick="onDesignNowClick(this)">Design Free</a>
                        </div>
    ...
    <script>
        ...
        function onDesignNowClick(anchor) {
            var nameInput = document.getElementById('live-card-input');
            if (nameInput && nameInput.value && nameInput.value.trim()) {
                anchor.href = 'editor-en.html?name=' + encodeURIComponent(nameInput.value.trim());
            }
        }
    </script>
</body>
...
console.log('Updated index.html and index-en.html successfully!');
