  ...
  bindEvents() {
    document.querySelectorAll("input, select, textarea").forEach((input) => {
      ...
      input.addEventListener("input", () => {
        ...
        if (input.id.startsWith("front-bg-") || input.id.startsWith("back-bg-"))
    ...
    document
      .querySelectorAll('input[name="layout-select-visual"]')
      .forEach((radio) => {
...
const App = {
  async init() {
    Object.assign(DOMElements, {
      ...
      backButtonsTextColor: document.getElementById("back-buttons-text-color"),
