...
const Config = {
    ...
    defaultState: {
        ...
        inputs: {
            ...
            'tagline-color': '#c5a059',
            'tagline-font': 'Tajawal, sans-serif',

            'toggle-phone-buttons': true,
            'phone-text-layout': 'row',
            'phone-text-size': 14,
            'phone-text-color': '#f0f6fc',
            'phone-text-font': 'Tajawal, sans-serif',
            'phone-btn-bg-color': '#c5a059',
            'phone-btn-text-color': '#0d1117',
            'phone-btn-font-size': 12,
            'phone-btn-padding': 6,
            'phone-btn-font': 'Tajawal, sans-serif',
            'front-bg-start': '#161b22',
            'front-bg-end': '#0d1117',
            'front-bg-opacity': 0,
            'qr-source': 'auto-card',
            'input-qr-url': '',
            'qr-size': 30,
            'back-bg-start': '#161b22',
            'back-bg-end': '#0d1117',
            'back-bg-opacity': 0,
            'back-buttons-size': 10,
            'back-buttons-bg-color': '#21262d',
            'back-buttons-text-color': '#8b949e',
            'back-buttons-font': 'Tajawal, sans-serif',
            'theme-select-input': 'deep-sea',
            'toggle-master-social': true,
            'toggle-social-buttons': true,
            'social-text-size': 12,
            'social-text-color': '#f0f6fc',
            'social-text-font': 'Tajawal, sans-serif',
            'social-btn-bg-color': '#21262d',
            'social-btn-text-color': '#8b949e',
            'social-btn-padding': 6,
            'social-btn-font': 'Tajawal, sans-serif',
            'toggle-additional-buttons': false,
            'additional-btn-bg-color': '#c5a059',
            'additional-btn-text-color': '#0d1117',
            'additional-btn-font-size': 12,
            'additional-btn-padding': 6,
            'additional-btn-font': 'Tajawal, sans-serif'
        },
        dynamic: {
            phones: [
    ...
    THEMES: {
        // --- Original Designs ---
        'deep-sea': { name: 'تنفيذي ذهبي', nameEn: 'Executive Gold', gradient: ['#161b22', '#0d1117'], values: { textPrimary: '#f0f6fc', taglineColor: '#c5a059', backButtonBg: '#21262d', backButtonText: '#8b949e', phoneBtnBg: '#c5a059', phoneBtnText: '#0d1117' } },
