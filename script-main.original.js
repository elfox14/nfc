...
function customConfirm(message) {
    return new Promise((resolve) => {
        ...
        overlay.style.cssText = 'position:fixed;inset:0;background:rgba(0,0,0,0.7);z-index:99999;display:flex;align-items:center;justify-content:center;backdrop-filter:blur(6px);';
        const box = document.createElement('div');
        box.style.cssText = 'background:#161b22;border:1px solid rgba(197,160,89,0.25);border-radius:16px;padding:30px;max-width:400px;width:90%;text-align:center;box-shadow:0 20px 60px rgba(0,0,0,0.7);';
        const msg = document.createElement('p');
        msg.textContent = message;
        msg.style.cssText = 'color:#f0f6fc;font-size:1.1rem;margin:0 0 25px;line-height:1.6;font-family:Tajawal,sans-serif;';
        const btns = document.createElement('div');
        btns.style.cssText = 'display:flex;gap:12px;justify-content:center;';
        const yesBtn = document.createElement('button');
        yesBtn.textContent = _isEnglishPage ? 'Yes' : 'نعم';
        yesBtn.style.cssText = 'padding:10px 32px;border-radius:10px;border:none;cursor:pointer;font-size:1rem;font-weight:700;font-family:inherit;background:#c5a059;color:#0d1117;transition:all 0.2s;';
        yesBtn.onmouseenter = () => yesBtn.style.background = '#d4af37';
        yesBtn.onmouseleave = () => yesBtn.style.background = '#c5a059';
        const noBtn = document.createElement('button');
        noBtn.textContent = _isEnglishPage ? 'No' : 'لا';
        noBtn.style.cssText = 'padding:10px 32px;border-radius:10px;border:1px solid rgba(240,246,252,0.15);cursor:pointer;font-size:1rem;font-weight:700;font-family:inherit;background:#21262d;color:#f0f6fc;transition:all 0.2s;';
        noBtn.onmouseenter = () => noBtn.style.background = '#30363d';
        noBtn.onmouseleave = () => noBtn.style.background = '#21262d';
