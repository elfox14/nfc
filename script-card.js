    ...
    setupDropzones() {
        ...
        interact('.card-content-layer').dropzone({
            ...
            ondrop: (event) => {
                ...
                // Elements are now dropped directly onto the single card content area.
                // We just reset their transform if they were dragged explicitly.
...
const CardManager = {
    bgImageUrl: null, qrCodeImageUrl: null, personalPhotoUrl: null,
    ...
    renderPhoneButtons() {
        ...
        DOMElements.phoneNumbersContainer.querySelectorAll('.dynamic-input-group').forEach((group) => {
            ...
            const parentContainer = DOMElements.cardContent;
    ...
    updateCardBackgrounds() {
        ...
        setBg(
            document.getElementById('bg-image-layer'),
            document.getElementById('bg-gradient-layer'),
            'bg-start', 'bg-end', this.bgImageUrl, 'bg-opacity'
        );
    },
    ...
    renderCardContent() {
        ...
        const container = DOMElements.cardContent;
        const elements = {
